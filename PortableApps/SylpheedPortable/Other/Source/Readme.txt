...
user in an INI file next to SylpheedPortable.exe called SylpheedPortable.ini.
...
copy AppNamePortable.ini from this directory to SylpheedPortable.ini next to
SylpheedPortable.exe. The options in the INI file are as follows:
