DEVELOPER: Replace the three occurrences of IsotoxinPortable in this file
...
user in an INI file next to IsotoxinPortable.exe called IsotoxinPortable.ini.
...
copy AppNamePortable.ini from this directory to IsotoxinPortable.ini next to
IsotoxinPortable.exe. The options in the INI file are as follows:
