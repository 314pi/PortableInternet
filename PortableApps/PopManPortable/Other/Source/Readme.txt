...
user in an INI file next to PopManPortable.exe called PopManPortable.ini.
...
copy AppNamePortable.ini from this directory to PopManPortable.ini next to
PopManPortable.exe. The options in the INI file are as follows:
