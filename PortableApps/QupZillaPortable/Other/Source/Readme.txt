...
user in an INI file next to QupZillaPortable.exe called QupZillaPortable.ini.
...
copy AppNamePortable.ini from this directory to QupZillaPortable.ini next to
QupZillaPortable.exe. The options in the INI file are as follows:
