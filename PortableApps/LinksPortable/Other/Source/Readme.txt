...
user in an INI file next to LinksPortable.exe called LinksPortable.ini.
...
copy AppNamePortable.ini from this directory to LinksPortable.ini next to
LinksPortable.exe. The options in the INI file are as follows:
