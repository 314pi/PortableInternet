...
user in an INI file next to FreeDownloadManagerPortable.exe called FreeDownloadManagerPortable.ini.
...
copy AppNamePortable.ini from this directory to FreeDownloadManagerPortable.ini next to
FreeDownloadManagerPortable.exe. The options in the INI file are as follows:
