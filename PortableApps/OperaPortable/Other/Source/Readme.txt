...
user in an INI file next to OperaPortable.exe called OperaPortable.ini.
...
copy AppNamePortable.ini from this directory to OperaPortable.ini next to
OperaPortable.exe. The options in the INI file are as follows:
