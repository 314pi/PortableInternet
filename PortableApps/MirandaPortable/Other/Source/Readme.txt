...
user in an INI file next to MirandaPortable.exe called MirandaPortable.ini.
...
copy AppNamePortable.ini from this directory to MirandaPortable.ini next to
MirandaPortable.exe. The options in the INI file are as follows:
