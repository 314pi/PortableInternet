...
user in an INI file next to MicroSIPPortable.exe called MicroSIPPortable.ini.
...
copy AppNamePortable.ini from this directory to MicroSIPPortable.ini next to
MicroSIPPortable.exe. The options in the INI file are as follows:
