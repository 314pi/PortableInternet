...
user in an INI file next to KiTTYPortable.exe called KiTTYPortable.ini.
...
copy AppNamePortable.ini from this directory to KiTTYPortable.ini next to
KiTTYPortable.exe. The options in the INI file are as follows:
