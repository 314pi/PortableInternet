...
user in an INI file next to KVIrcPortable.exe called KVIrcPortable.ini.
...
copy AppNamePortable.ini from this directory to KVIrcPortable.ini next to
KVIrcPortable.exe. The options in the INI file are as follows:
