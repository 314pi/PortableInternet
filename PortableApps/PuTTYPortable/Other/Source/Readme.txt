...
user in an INI file next to PuTTYPortable.exe called PuTTYPortable.ini.
...
copy AppNamePortable.ini from this directory to PuTTYPortable.ini next to
PuTTYPortable.exe. The options in the INI file are as follows:
