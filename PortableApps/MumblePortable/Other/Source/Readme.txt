...
user in an INI file next to MumblePortable.exe called MumblePortable.ini.
...
copy AppNamePortable.ini from this directory to MumblePortable.ini next to
MumblePortable.exe. The options in the INI file are as follows:
