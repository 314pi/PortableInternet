...
user in an INI file next to K-MeleonPortable.exe called K-MeleonPortable.ini.
...
copy AppNamePortable.ini from this directory to K-MeleonPortable.ini next to
K-MeleonPortable.exe. The options in the INI file are as follows:
