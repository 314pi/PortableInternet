...
user in an INI file next to MaxthonPortable.exe called MaxthonPortable.ini.
...
copy AppNamePortable.ini from this directory to MaxthonPortable.ini next to
MaxthonPortable.exe. The options in the INI file are as follows:
