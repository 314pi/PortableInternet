DEVELOPER: Replace the three occurrences of HexChatPortable in this file
...
user in an INI file next to HexChatPortable.exe called HexChatPortable.ini.
...
copy AppNamePortable.ini from this directory to HexChatPortable.ini next to
HexChatPortable.exe. The options in the INI file are as follows:
