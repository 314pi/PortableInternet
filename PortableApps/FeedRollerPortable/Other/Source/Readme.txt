...
user in an INI file next to FeedRollerPortable.exe called FeedRollerPortable.ini.
...
copy AppNamePortable.ini from this directory to FeedRollerPortable.ini next to
FeedRollerPortable.exe. The options in the INI file are as follows:
