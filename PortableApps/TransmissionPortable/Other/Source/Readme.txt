...
user in an INI file next to TransmissionPortable.exe called TransmissionPortable.ini.
...
copy AppNamePortable.ini from this directory to TransmissionPortable.ini next to
TransmissionPortable.exe. The options in the INI file are as follows:
