...
user in an INI file next to QuiteRSSPortable.exe called QuiteRSSPortable.ini.
...
copy AppNamePortable.ini from this directory to QuiteRSSPortable.ini next to
QuiteRSSPortable.exe. The options in the INI file are as follows:
