...
user in an INI file next to MirandaNGPortable.exe called MirandaNGPortable.ini.
...
copy AppNamePortable.ini from this directory to MirandaNGPortable.ini next to
MirandaNGPortable.exe. The options in the INI file are as follows:
