...
console.assert(domainPattern.indexOf('*')===-1,'Domain pattern may only have 1 wildcard.');var prefixes={};prefixes[prefix]={product:0,type:type};ProductRegistryImpl.register([productName],[{hash:ProductRegistryImpl._hashForDomain(domainPattern),prefixes:prefixes}]);};;