...
static _parsePercentOrNumber(value,onlyInteger){if(isNaN(value.replace('%','')))
return null;var parsed=parseFloat(value);if(onlyInteger&&(value.indexOf('.')!==-1||!Number.isInteger(parsed)))
return null;if(value.indexOf('%')!==-1){if(value.indexOf('%')!==value.length-1)
return null;return parsed/100;}
return parsed;}
static _parseRgbNumeric(value){var parsed=Common.Color._parsePercentOrNumber(value,true);if(parsed===null)
...
static _parseAlphaNumeric(value){return Common.Color._parsePercentOrNumber(value,false);}
